...
var connectionString = builder.Configuration.GetConnectionString("TachyonDbContextConnection") ?? throw new InvalidOperationException("Connection string 'ApplicationDBContextConnection' not found.");
