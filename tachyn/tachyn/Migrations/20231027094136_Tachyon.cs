...
{
    public partial class Tachyon : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProcedureFeedbacks",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HasUndergoneProcedure = table.Column<bool>(type: "bit", nullable: false),
                    ProcedureName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PostProcedureExperience = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ManagementOfSideEffects = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OverallSatisfaction = table.Column<int>(type: "int", nullable: false),
                    Rating = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcedureFeedbacks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcedureName", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppView_AspNetUsers_PatientID",
                        column: x => x.PatientID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_familyReferrals", x => x.FamilyPrescriptionID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_medicationRecords_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1322515d-9101-4213-a257-ae652f9b1e0d", "47eeeb13-3845-474b-a521-02dd9548e617", "Admin", "ADMIN" },
                    { "2ca41d87-c14e-44ab-b5bf-549381362752", "217a78a3-6fd6-47fc-af3d-23c478db4186", "Nurse", "NURSE" },
                    { "5cfe7ffd-a7cd-4866-8316-e81763c25c3b", "5eadda62-218c-44dd-aea8-06bfb068be76", "Patient", "PATIENT" },
                    { "7b089750-1395-4037-ae5c-b5b2748ad1c5", "2959fae6-3d87-4abc-9359-593ccc684934", "Doctor", "Doctor" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_medicationRecords_UserId",
