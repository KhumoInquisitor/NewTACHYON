    ...
    public partial class tableDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentViewModel", x => x.AppointmentId);
                    table.ForeignKey(
                        name: "FK_AppointmentViewModel_AspNetUsers_PatientID",
                        column: x => x.PatientID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedHistory = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    PhyExam = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    BloodTests = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "053deac3-632a-48c7-b0b1-bf26ae87f080", "2d7ab2cf-7173-43d7-9e41-c4b13b5a7775", "Patient", "PATIENT" },
                    { "83c1ba87-2c2c-4a53-b62a-5454bb090482", "6e888a58-2aca-4d94-b61e-d13e182aaa65", "Nurse", "NURSE" },
                    { "e3fe4cac-7ac6-4436-9b78-a159ed840f26", "ab446649-043b-4c82-9a3f-f72b432d740d", "Admin", "ADMIN" },
                    { "fbbd3073-b1fe-4d92-ac1f-71faf4aa25f6", "4329e764-f462-4770-9173-12679d39727d", "Doctor", "Doctor" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentViewModel_PatientID",
